...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/papicoin-project/papicoin>";
    const std::string URL_WEBSITE = "<https://papicoin.org>";
