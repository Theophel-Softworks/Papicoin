...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s papicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  papicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded papicoin transaction") + "\n" +
              "  papicoin-tx [options] -create [commands]   " + _("Create hex-encoded papicoin transaction") + "\n" +
              "\n";
