...
#if defined(NDEBUG)
# error "Papicoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Papicoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s PPB additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	if (nHeight == 0)
		...
		nSubsidy = 23000000 * COIN; //Foundation
	else if (nHeight == 3)
		nSubsidy = 12000000 * COIN; //Premine
	else if (nHeight == 750)
		nSubsidy = 3000000 * COIN; //ICO
	else if (nHeight < 262800)
		nSubsidy = 60 * COIN; //Early Mining Phase Stage 1
	else if (nHeight < 525600)
		nSubsidy = 40 * COIN; //Early Mining Phase Stage 2
	else
		nSubsidy = 20 * COIN; //Reward
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Papicoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
