...
const char * const BITCOIN_CONF_FILENAME = "papicoin.conf";
const char * const BITCOIN_PID_FILENAME = "papicoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Papicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Papicoin";
#else
    // Unix
    return pathRet / ".papicoin";
#endif
#endif
}
